...
public enum Notice{
    ...
    DRILL_HOLE_NOT_EXIST("钻孔信息不存在", 111004),
    DRILL_DAILY_NOT_EXIST("钻孔日报信息不存在", 111005),
    DRILL_DAILY_ALREADY_EXIST("钻孔日报信息已存在", 111006),
    SET_LENGTH_MORE_LEFT_LENGTH("设置工作长度大于剩余长度", 111007),
    LENGTH_SHOULD_MORE_ZERO("长度不能小于等于0", 111008),
    DRILL_DAILY_DETAIL_NOT_EXIST("打钻详情不存在", 111009),
    DRIVING_DAILY_NOT_EXIST("掘进日报信息不存在", 111010),
    DRIVING_DAILY_ALREADY_EXIST("掘进日报信息已存在", 111011),
    DAILY_DETAIL_ALREADY_EXIST("日报详情已存在", 111012),
    DAILY_DETAIL_NOT_EXIST("日报详情不存在", 111013),
